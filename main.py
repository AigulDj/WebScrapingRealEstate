...
#     currency = driver.find_elements(By.CLASS_NAME, "price")
#
#     image = [img.get_attribute('data-src') if True else "n/a" for img in images]
#     title = [title.text for title in titles]
#     date = [TODAY if "ago" in date.text else date.text for date in dates]
...
#     currency = [cur.text[0] for cur in currency]
#
